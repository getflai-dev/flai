...
class _GoogleLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bluePath = Path()
      ...
      ..cubicTo(17.66 * s, 15.63 * s, 16.89 * s, 16.79 * s, 15.72 * s,
          17.58 * s)
      ..lineTo(15.72 * s, 20.35 * s)
      ..lineTo(19.28 * s, 20.35 * s)
      ..cubicTo(21.36 * s, 18.43 * s, 22.56 * s, 15.61 * s, 22.56 * s,
          12.25 * s)
      ..close();
    ...
    final greenPath = Path()
      ...
      ..cubicTo(14.74 * s, 18.24 * s, 13.49 * s, 18.64 * s, 12 * s,
          18.64 * s)
      ..cubicTo(9.14 * s, 18.64 * s, 6.71 * s, 16.71 * s, 5.84 * s,
          14.11 * s)
